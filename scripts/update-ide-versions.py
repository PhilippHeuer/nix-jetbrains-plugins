...
def main():
  ...
  ideVersions = fetch_nixpkgs_ide_versions(FLAKE_INPUTS)
  merge_nixpkgs_ide_versions("data/ide-version.json", ideVersions)
  logging.info("successfully persisted ide versions to ide-version.json")
